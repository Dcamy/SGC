    ...
    return (
        <article className="flex flex-col h-full" data-aos="fade-up">
            ...
            <article className="flex flex-col h-full" data-aos="fade-up">
                <header>
                    <Link to="/blog-post" className="block mb-6">
                        <h3 className="h4 mb-2">
                            <Link to="/blog-post" className="hover:text-gray-100 transition duration-150 ease-in-out">Project SGC</Link>
                        </h3>
                        <figure className="relative h-0 pb-9/16 overflow-hidden rounded-sm">
                            <img className="absolute inset-0 w-full h-full object-cover transform hover:scale-105 transition duration-700 ease-out" src={require('../images/da3624d7-0c63-4391-be3d-72a99cc1bda1.webp').default} width="352" height="198" alt="News 01" />
                        </figure>
                    </Link>
                    <div className="mb-3">
                ...
                <p className="text-lg text-gray-400 flex-grow">Empower your contribution with SGC: the asset of the DAO. Stake for loans, secure life insurance, and grow wealth as value ascends. It's your stake in a prosperous future.</p>
